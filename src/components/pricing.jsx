...
const pricingGroups = [
  {
    ...
    items: [
      { service: "Basic Cleaning", price: "399", note: "Light dirt, daily use shoes" },
      { service: "Deep Cleaning", price: "₹499", note: "Most Popular", badge: "Popular" },
  ...
  },
  {
    ...
    items: [
      { service: "Minor Repair", price: "₹349", note: "Glue, stitching" },
      { service: "Heel Repair", price: "₹499", note: "Heels fix" },
      { service: "Sole Repair", price: "₹499", note: "Most demanded", badge: "Popular" },
